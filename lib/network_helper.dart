...
const String _LINKEDIN_BASE_URL = "www.linkedin.com";
const String _LINKEDIN_PROFILE_URL =
...
class NetworkHelper {
  Future<AccessResponse> getLinkedInAccessToken(AccessOptions options) async {
    final url = Uri.https(_LINKEDIN_BASE_URL, 'oauth/v2/accessToken', {
  ...
  Future<LinkedInProfileResponse> getLinkedInInformation(
    ...
    try {
      final response = await http.get(_LINKEDIN_PROFILE_URL,
